...
function Home() {
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible">
      <section
        id="home"
        className={`relative scroll-mt-20 min-h-screen grid grid-cols-1 md:grid-cols-2 items-center gap-16 max-w-7xl mx-auto px-6 pt-32 pb-20 md:pt-20 ${bgClass}`}
      >
        ...
        <div>
          ...
          <motion.h1 variants={itemVariants} className="text-3xl md:text-6xl font-extrabold text-[#A855F7]">
            Rihanat
          </motion.h1>

          <motion.h2 variants={itemVariants} className="text-2xl md:text-3xl font-semibold mt-4">
          ...
          <motion.p variants={itemVariants} className="mt-6 text-lg leading-8 text-gray-400 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            <a
              href="#projects"
              className="px-6 py-3 bg-[#A855F7] text-white rounded-lg hover:bg-[#9333EA] transition text-center"
            >
              View My Projects
            </a>
            ...
            <a
              href="#contact"
              className="px-6 py-3 border-2 border-[#A855F7] text-[#7209d4] rounded-lg hover:bg-[#8852be] transition"
            >
              Contact Me
            </a>
            ...
            <a
              ...
              className="px-6 py-3 bg-transparent border-2 border-[#A855F7] text-[#A855F7] rounded-lg hover:bg-[#A855F7] hover:text-white transition"
          ...
          <div className="flex gap-4 mt-4">
            <a href="https://github.com/adeoyerihanat6-prog" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <FaGithub className="text-4xl text-[#A855F7] mt-6 hover:text-[#9333EA] transition" />
            </a>
            <a href="https://www.linkedin.com/in/rihanat-adeoye-2a5059395" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <FaLinkedin className="text-4xl text-[#A855F7] mt-6 hover:text-[#9333EA] transition" />
            </a>
            <a href="https://x.com/riha66076" target="_blank" rel="noopener noreferrer" aria-label="X">
              <FaXTwitter className="text-4xl text-[#A855F7] mt-6 hover:text-[#9333EA] transition" />
            </a>
            <a href="mailto:adeoyerihant6@gmail.com" aria-label="Email">
              <FaEnvelope className="text-4xl text-[#A855F7] mt-6 hover:text-[#9333EA] transition" />
            </a>
            <a href="http://wa.me/2349015162388" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
        ...
        <div className="flex justify-center items-center">
          <div className="relative h-80 w-80 rounded-full border-2 border-[#A855F7] shadow-2xl shadow-purple-500/40 transition-all duration-500 hover:shadow-purple-400/80">
            <motion.img
              src={rihan}
              alt="Rihanat"
        ...
        >
          <div className="w-6 h-10 border-2 border-[#A855F7] rounded-full flex justify-center">
            <div className="w-1 h-3 bg-[#A855F7] rounded-full mt-2" />
          </div>
        </motion.div>
      </section>

      <div className="h-px bg-gradient-to-r from-transparent via-[#A855F7]/40 to-transparent" />
    </motion.div>
  );
}
